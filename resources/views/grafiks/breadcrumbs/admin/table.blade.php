            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" style="width:300px">
                        {{Form::open(['route'=>['admin.poverka.update', $item->id], 'method'=>'put'])}}
            ...
            <td>
                ...
                <div class="btn-group">
                    ...
                    <div class="dropdown-menu" style="width:300px">
                        <div class="input-group">
                            <input type="text"
                                   class="form-control pull-right"
                                   id="datePlanWork{{$item->id}}"
                                   name="datePlanWork"
                                   value=""
                                   placeholder="Редагувати строк виконання">
                            <span class="input-group-prepend">
                    ...
                    <div class="btn-group">
                        ...
                        <div class="dropdown-menu" style="width:300px">
                            <div class="input-group">
                                <input type="text"
                                       class="form-control pull-right"
                                       id="dateFactWork{{$item->id}}"
                                       name="dateFactWork"
                                       value=""
                                       placeholder="Редагувати дату виконання">
                                <span class="input-group-prepend">
                                                <button type="submit" value="search-full" name="button-name"
                                                        class="btn btn-primary">OK</button>
                                                    </span>
                ...
                @else
                    <div class="btn-group">
                        ...
                        {{Form::open(['route'=>['admin.poverka.store'], 'method'=>'post'])}}
                        <div class="dropdown-menu" style="width:300px">
                            <div class="input-group">
                                <input type="text"
                                       class="form-control pull-right"
                                       ...
                                       name="dateFactWork"
                                       value=""
                                       placeholder="Ввести дату виконання">
                                <span class="input-group-prepend">
                                                <button type="submit" value="search-full" name="button-name"
                                                        class="btn btn-primary">OK</button>
                                                    </span>
