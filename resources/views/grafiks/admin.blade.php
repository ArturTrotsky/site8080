...
@section('content')
    ...
    <div class="content-wrapper">
                    ...
                    <div class="card card-default">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-md-2">
                                    {{Form::open(['route'=>['admin.poverka.reset', $dateFrom], 'method'=>'post'])}}
                                    <div class="form-group">
                                ...
                                @include('grafiks.breadcrumbs.admin.filterInfo')
                                ...
                                @if(json_decode($grafikIdJson))
                                    <div class="col-md-2">
                                        ...
                                        {{Form::open([
                                        'route'=>['admin.grafiks.showPDF'], 'method'=>'post', 'target'=>'_blank'
                                        ])}}
                                        <div class="form-group">
                                            <div class="input-group">
                                            ...
                                            <input type="hidden" name="podrazdelenie" value="{{$podrazdelenie}}">
                                            <input type="hidden" name="kabinet" value="{{$kabinet}}">
                                            <input type="hidden" name="laboratory" value="{{$laboratory}}">
                                            <input type="hidden" name="brigade" value="{{$brigade}}">
                                        </div>
                                        {{Form::close()}}
                                    </div>
                                @endif
                ...
                <div class="col-md-12">
                    <div class="card card-default">
                        <div class="card-body">
                            ...
                            {{--Подключение таблицы--}}
                            @include('grafiks.breadcrumbs.admin.table')
                            {{--Конец таблицы--}}
        ...
        @include('grafiks.breadcrumbs.admin.filter')
        {{--Конец фильтров--}}
