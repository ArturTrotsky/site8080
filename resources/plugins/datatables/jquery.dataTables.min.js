...
(function (h) {
    ...
    n.defaults = {
        ...
        oLanguage: {
            ...
            oPaginate: {sFirst: "Перша", sLast: "Остання", sNext: "Наступна", sPrevious: "Попередня"},
            sEmptyTable: "Немає даних у таблиці",
            sInfo: "Показано вiд _START_ до _END_ iз _TOTAL_ записiв",
            sInfoEmpty: "Показано вiд 0 до 0 iз 0 записiв",
